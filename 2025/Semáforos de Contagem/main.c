...
/**
 * @brief Cria lista 1 com valores do arquivo
 *
...
void* filtra_primos(void *arg){
    ...
    while(1){
        ...
        if(valor == -1){
            ...
            // Verifica se o valor lido é primo
            is_primo = verifica_primo(valor);
            // Se for primo
            if(is_primo){
...
int main(int argc, char **argv)
{
    if(argc != 2){
        ...
        pthread_t thread_le, thread_impares, thread_primos, thread_imprime;
        ...
        pthread_create(&thread_le, NULL, le_arquivo, NULL);
